...
import type { FormItemRule, FormRulesMap } from 'element-plus/lib/components/form/src/form.type';
import type {
  UnknownObject,
  IComponentSize,
  IButtonProps,
...
export interface ColFormTypeComponentItem {
  component: Component | string;
  props?: UnknownObject;
}

export interface IColFormTypeComponent {
  formTypeComponent?: { add?: ColFormTypeComponentItem; edit?: ColFormTypeComponentItem; search?: ColFormTypeComponentItem };
}
...
export interface FormColumn<T = ExternalParam> extends IColProps, StringObject {
  ...
  slot?: boolean;
  /** component name */
  component?: string | Component | IColFormTypeComponent;
  /** props for component */
  props?: UnknownObject;
  /** sub-form */
...
export type IFormSubmit = (done: () => void, isValid: boolean, invalidFields?: InvalidFields) => void;
