...
import type { TableProps, DefaultRow } from 'element-plus/packages/components/table/src/table/defaults';
import type {
...
export default {
  ...
  showSummary: Boolean,
  sumText: String,
  summaryMethod: Function as unknown as PropType<TableProps<DefaultRow>['summaryMethod']>,
  ...
  spanMethod: Function as unknown as PropType<TableProps<DefaultRow>['spanMethod']>,
  ...
  lazy: Boolean,
  load: Function as unknown as PropType<TableProps<DefaultRow>['load']>,
  style: {
